...
public class ThreadFour implements Runnable {
    ...
    public ThreadFour(int flag, PrintFunction printFunction) {
        this.flag = flag;
    ...
    public static void main(String[] args) {
        new Thread(new ThreadFour(0, (n) -> System.out.print("C"))).start();
        new Thread(new ThreadFour(1, (n) -> System.out.print("B"))).start();
        new Thread(new ThreadFour(2, (n) -> System.out.print("A"))).start();
        new Thread(new ThreadFour(3, (n) -> System.out.print(n))).start();
    }
